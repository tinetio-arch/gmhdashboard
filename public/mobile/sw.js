...
self.addEventListener('push', (e) => {
  ...
  const options = {
    body: data.body || '',
    icon: self.registration.scope.includes('/mobile/') ? '/mobile/icon-192.png' : '/ipad/icon-192.png',
    badge: self.registration.scope.includes('/mobile/') ? '/mobile/badge-72.png' : '/ipad/badge-72.png',
